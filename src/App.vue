...
const getThemeFromLocalStorage = () => {
  ...
  return savedTheme ? JSON.parse(savedTheme) : true; // Mặc định là Light theme
};
...
onMounted(() => {
  ...
  isLightMode.value = savedTheme;
  updateTheme(savedTheme); // Áp dụng theme khi tải

  // Cung cấp giá trị isLightMode cho toàn bộ các component con
