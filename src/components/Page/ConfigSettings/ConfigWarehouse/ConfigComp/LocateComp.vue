<template>
  <div class="container p-4 rounded-2">
    <div class="mb-3 d-flex justify-content-between align-items-center">
      <h4 class="fw-bold">Khu vực</h4>
      <button
        type="button"
        class="btn btn-primary d-flex align-items-center"
        data-bs-toggle="modal"
        data-bs-target="#locateModal"
      >
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fw-bold" id="warehouseModalLabel">Thêm Khu vực</h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          <form>
            <div class="mb-3">
              <label for="warehouseId" class="form-label">Mã khu vực</label>
              <input
                type="text"
                class="form-control"
                id="warehouseId"
            ...
            <div class="mb-3">
              <label for="warehouseName" class="form-label">Tên khu vực</label>
              <input
                type="text"
                class="form-control"
                id="warehouseName"
...
const warehouses = ref([
  { id: 1, name: "Khu vực 1", locate: "Địa chỉ 1", description: "Mô tả" },
  {
    id: 2,
    name: "Khu vực 1",
    locate: "Địa chỉ 1",
  ...
  { id: 3, name: "Khu vực 1", locate: "Địa chỉ 1", description: "Mô tả" },
]);
